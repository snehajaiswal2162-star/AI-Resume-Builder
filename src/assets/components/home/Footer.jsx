...
const Footer = () => {
  return (
    <div>
        <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-br from-white via-blue-300/60 to-white mt-45">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center">© 2025 Resume Builder<a href="https://prebuiltui.com"></a></p>
                </div>
            </footer>
    </div>
  )
