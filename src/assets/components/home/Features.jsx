...
const Features = () => {
    ...
    return (
        ...
        <Title title='Build your resume' description='Our streamlined process makes it easy to create a professional resume in minutes with intelligent features AI-powered tools and features.' />
