...
const Testimonials = () => {
  ...
  return (
    <div  id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
      <div className='flex items-center gap-2 text-sm text-gray-600 bg-blue-400/10 rounded-full px-6 py-1.5'>
        <BookUserIcon className='size-4 stroke-blue-500' /> <span>Testimonials</span>
      </div>
      <Title title="Don't just take our words" description="Here what our's user says about us. We're always looking a way to improve. If you have a postitve experience with us, leave a review."/>
