...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      id: "minimal",
      name: "Minimal",
      preview: "Minimal design with the single image and clean typography.",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {isOpen && (
            <div className="absolute top-full w-xs p-3 mt-2 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-md max-h-64 overflow-y-auto scrollbar-none">
                        ...
                        {selectedTemplate === template.id && (
                            <div className="absolute top-2 right-2 ">
                                <div className="size-5 bg-blue-500 rounded-full flex items-center justify-center">
                                    <Check className="w-3 h-3 bg-white" />
                                </div>
                            </div>
                        )}
